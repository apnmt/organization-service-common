...
import de.apnmt.organization.common.service.AddresseService;
...
/**
 * REST controller for managing {@link Addresse}.
 */
@RestController
@RequestMapping("/api")
public class AddresseResource {
    ...
    private static final String ENTITY_NAME = "organizationServiceAddresse";
